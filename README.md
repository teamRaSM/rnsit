...
## Branches
  ...
  - deveop : This is same as that of master branch but with minified css and js. So commit here after minification.
  ...
  ### Commit all the changes with minified files to develop branch.
